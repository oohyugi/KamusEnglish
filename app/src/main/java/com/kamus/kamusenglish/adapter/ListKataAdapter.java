package com.kamus.kamusenglish.adapter;
...
import com.kamus.kamusenglish.R;
...
public class ListKataAdapter extends BaseAdapter{
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.item_kata, null);
			holder.txtKata = (TextView)v.findViewById(R.id.iKata);
		...
		holder.txtKata.setText(listKamus.get(arg0).getArti());
